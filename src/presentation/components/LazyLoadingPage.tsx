  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-0 right-0 w-[200px] h-[200px] bg-primary/5 rounded-full blur-[100px]" />
      </div>

      <div className="relative flex flex-col items-center gap-8 text-center px-4 w-full max-w-sm">
        <div className="relative group">
          <div className="absolute -inset-6 bg-gradient-to-r from-primary/30 to-primary/20 rounded-2xl opacity-40 blur-xl" />
          <div className="relative w-20 h-20 border border-border/50 rounded-2xl flex items-center justify-center shadow-2xl bg-card/60 backdrop-blur-xl overflow-hidden">
            ...
            <Car className="w-9 h-9 text-primary relative z-10 animate-pulse" strokeWidth={1.5} />
          </div>
        ...
        <div className="w-64 h-1.5 bg-muted rounded-full overflow-hidden border border-border/50">
          <div className="h-full bg-gradient-to-r from-primary via-primary/70 to-primary/50 w-1/3 rounded-full animate-[loading_2s_infinite_ease-in-out]" />
        </div>
      </div>
